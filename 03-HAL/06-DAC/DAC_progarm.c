...
#include "DAC_interfac.h"
#include "DAC_config.h"
#include "DAC_privat.h"
...
void DAC_voidInit(u8* Copy_Ptru8Data,u16 Copy_u16length){
	...
	u8* Ptru8Data = Copy_Ptru8Data;
	u16 u16length=Copy_u16length;
...
void DAC_voidOutDACValue(u16 Copy_u16Frequencey){
	...
	MSTK_voidSetIntervalPeriodic(Local_u16FrameTimer,void_SetDAC);
}
...
static void DAC_voidOutDACFrame(void)
{
		...
		GPIO_voidSetPortValue(DAC_PORT,audio_raw[u16iterator]);		
